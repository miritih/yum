...
class SellersControllerTest < ActionController::TestCase
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post :create, seller: { description: @seller.description, image_url: @seller.image_url, name: @seller.name }
    end
  ...
  test "should update seller" do
    patch :update, id: @seller, seller: { description: @seller.description, image_url: @seller.image_url, name: @seller.name }
    assert_redirected_to seller_path(assigns(:seller))
  end
